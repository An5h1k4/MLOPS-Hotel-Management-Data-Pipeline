...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            cat_cols = self.config["data_processing"]["catagorical_columns"] #config has the yaml file we are simply dividing the data into catagorical and numerical data
            ...
            logger.info("Laberl Mappings are: ")
        ...
        #imbalaced data handeling
    def balance_data(self, df):
        try:
            logger.info("Handeling Imbalanced Data")
    ...
    def select_features(self, df):
        try:
            ...
            raise CustomException("Error while selecting the feature",e)
    
    #save data from df->.csv
    def save_data(self, df, file_path):
        try:
            ...
            raise CustomException("Error while saving the data process",e)
    ...
    def process(self):
        try:
            ...
            logger.error(f"Error during preprocess pipeline step {e}")
            raise CustomException("Error while data preprocess pipeline",e)
